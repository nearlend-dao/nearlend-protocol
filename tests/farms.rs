...
fn test_farm_supplied() {
    ...
    let nel_token_before = e.get_balance(&e.booster_token, &users.alice).0;
    ...
    let nel_token_after_skip_3_days = e.get_balance(&e.booster_token, &users.alice).0;
    ...
    println!(
        ...
        &e.get_balance(&e.booster_token, &users.alice)
    );
    assert_balances(
        &account.supplied,
        &[
    ...
    // Claim all rewards
    e.account_farm_claim_all(&users.alice).assert_success();
    let nel_token_after_skip_30_days = &e.get_balance(&e.booster_token, &users.alice).0;
...
fn test_farm_supplied_2() {
    ...
    let alice_nel_token_before = e.get_balance(&e.booster_token, &users.alice).0;
    let bob_nel_token_before = e.get_balance(&e.booster_token, &users.bob).0;
    ...
    let alice_nel_token_after_skip_3_days = e.get_balance(&e.booster_token, &users.alice).0;
    let bob_nel_token_after_skip_3_days = e.get_balance(&e.booster_token, &users.bob).0;
    ...
    e.account_farm_claim_all(&users.alice).assert_success();
    e.account_farm_claim_all(&users.bob).assert_success();
    let alice_nel_token_after_skip_30_days = e.get_balance(&e.booster_token, &users.alice).0;
    let bob_nel_token_after_skip_30_days = e.get_balance(&e.booster_token, &users.bob).0;
...
//     // claim the reward
//     e.account_farm_claim_all(&users.alice).assert_success();
//     let nel_token_after_skip_10_days = e.get_balance(&e.booster_token, &users.alice).0;
...
//     );
//     let nel_token_before = e.get_balance(&e.booster_token, &users.bob).0;
//     println!("===> Account before: {:?}", account);
...
//     // claim the reward
//     e.account_farm_claim_all(&users.bob).assert_success();
//     let nel_token_after_skip_10_days = e.get_balance(&e.booster_token, &users.bob).0;
...
//     println!(
//         "===> Account NEL token after claim: {:?}",
//         &e.get_balance(&e.booster_token, &users.bob)
//     );
